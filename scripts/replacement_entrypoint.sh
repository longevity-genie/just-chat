#!/usr/bin/env bash
#
# This script is the copy of the entrypoint.sh script for the chat-ui-agents container. 
# If necessary, you can modify it and replace the original entrypoint.sh script in the docker-compose.yml file.
# To do so, uncomment the following line in the docker-compose.yml file:
#   entrypoint: [ "/usr/local/bin/entrypoint.sh" ]
#
# Then, you can modify this script to add any additional setup or configuration you need.
#
